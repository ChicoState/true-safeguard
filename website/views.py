...
def resources(request):
    resource_data = [
        ...
        },
        {
            ...
            'links': [
                {
                    'title': 'Open-Ended Play Resources',
                    'url': 'https://www.naeyc.org'
                },
                {
                    'title': 'Screen-Free Week Toolkits',
                    'url': 'https://www.screenfree.org'
                },
            ]
        },
        {
            ...
            'links': [
                {
                    'title': 'CARD Official Website',
                    'url': 'https://www.chicorec.gov/'
                },
                {
                    'title': 'Park Explorers Survival Club',
                    'url': 'https://www.chicorec.gov/park-explorers-survival-club'
                },
                {
                    'title': 'Chico Creek Nature Center',
                    'url': 'https://www.chicorec.gov/chico-creek-nature-center'
                },
            ]
        }
    ]
